...
1. Test receipt display to verify ordering matches admin website
2. Verify intermediate totals display correctly
3. Test sync to verify pagos_recibos is populated correctly
