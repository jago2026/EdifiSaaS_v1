    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <div className="bg-amber-50 p-6 rounded-xl shadow-sm cursor-pointer hover:bg-amber-100/50 border border-amber-200 group transition-colors" onClick={() => setActiveTab("manual")} title="Saldo bancario registrado manualmente.">
          <div className="text-sm text-amber-700 mb-1 font-black uppercase tracking-tight">Saldo Manual</div>
          ...
          {(tasaBCV?.dolar || 0) > 0 && <div className="text-sm text-amber-600 font-bold">$ {formatUsd((movimientosManual[0]?.saldo_acumulado || 0) / (tasaBCV.dolar || 45))}</div>}
        </div>
