    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 font-sans">
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-6 leading-tight tracking-tighter">
            Gestión Financiera para Juntas de Condominio.
          </h1>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-6">
          ...
          <p className="text-[10px] text-gray-500 mt-8 max-w-4xl mx-auto text-center leading-relaxed font-medium">
            <strong>Aviso de Propiedad Intelectual y Marcas:</strong> El nombre "Rascacielo" es una marca registrada y propiedad intelectual de sus respectivos creadores. EdifiSaaS no tiene relación laboral, societaria ni comercial directa con la empresa propietaria de dicho software, ni con las administradoras de condominios mencionadas en este sitio web. La mención de estos nombres se realiza exclusivamente con fines informativos y de referencia de compatibilidad técnica, para orientar al usuario final sobre el alcance de nuestra plataforma. EdifiSaaS es una solución independiente que procesa la información de consulta del usuario para ofrecer herramientas de análisis financiero adicionales.
          </p>
        </div>
      </footer>
    </main>
